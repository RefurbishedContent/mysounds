...
const MixerView: React.FC<MixerViewProps> = ({ onCreateNew, onOpenSession }) => {
  ...
  return (
    <div className="h-full flex flex-col p-3 md:p-4 bg-gray-900">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h1 className="text-lg font-bold text-white mb-0.5">DJ Mixer</h1>
          <p className="text-xs text-gray-400">Create seamless mix playlists from your mash ups</p>
        </div>

        <button
          onClick={onCreateNew}
          className="flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white text-sm rounded-lg font-medium transition-all shadow-lg shadow-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/50"
        >
          <Plus size={16} />
          <span>New Mix</span>
        </button>
      ...
      {mixSessions.length === 0 ? (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center space-y-3 max-w-md">
            <div className="w-10 h-10 bg-gradient-to-r from-cyan-600/20 via-blue-600/20 to-purple-600/20 rounded-xl flex items-center justify-center mx-auto shadow-lg shadow-cyan-500/20">
              <Sliders size={20} className="text-cyan-400" />
            </div>

            <div className="space-y-1">
              <h2 className="text-base font-bold text-white">No Mix Sessions Yet</h2>
            ...
            <div className="border-t border-gray-700 pt-3">
              <h3 className="text-xs text-white font-medium mb-2">Mixer Features</h3>
              <div className="grid grid-cols-2 gap-2 text-center">
                <div className="space-y-1">
                  <Volume2 size={16} className="text-gray-500 mx-auto" />
                ...
                <div className="space-y-1">
                  <Equalizer size={16} className="text-gray-500 mx-auto" />
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    {session.status === 'rendering' && (
                      <div className="px-2 py-0.5 bg-cyan-500/20 text-cyan-400 text-xs rounded-full">
                        Rendering
                      </div>
                    )}
                    <button
