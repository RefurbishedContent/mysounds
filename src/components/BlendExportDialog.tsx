...
export const BlendExportDialog: React.FC<BlendExportDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto overflow-x-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <h2 className="text-xl font-semibold text-white">Export Full Song Mash Up</h2>
          <button
            onClick={onClose}
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-red-100/80 text-sm mb-3">
                    This transition hasn't been rendered yet. You need to open the transition editor and click "Save" to render the audio before you can export a full mash up.
                  </p>
          ...
          {!isExporting && !exportComplete && !transitionNotRendered && (
            <>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-cyan-100/80 text-sm mb-3">
                      Your export will include the <strong>complete songs</strong> seamlessly joined with your custom-rendered transition zone containing the perfectly mashed up segments.
                    </p>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Mash Up Composition</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Custom mash up segments with fades</p>
                      </div>
                    </div>
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400 mt-1">
                  Your full song mash up is being processed. You can find it in the Mash Ups section of your Library.
                </div>
              </div>
            </div>
          )}
