...
import { Home, Music, Disc3, Headphones, Settings, Folder, AudioWaveform as Waveform, Sliders, FileAudio, User, Bell, Search, Menu, X, Activity, HelpCircle, Plus, Sparkles, Wand2, Video, Mic, Grid3X3, Clock, Share2, ListMusic, Zap, Brain, FlaskConical, ChevronLeft, ChevronRight, Layers } from 'lucide-react';
              ...
              {menuSections.map((section, sectionIndex) => (
                <div key={sectionIndex} className="space-y-0.5">
                  {section.title && !isSidebarCollapsed && (
                    <h3
                      className="px-2 text-xs font-semibold uppercase tracking-wider mb-0.5 bg-clip-text text-transparent"
                      style={{
                        backgroundImage: 'linear-gradient(90deg, #22d3ee, #3b82f6, #8b5cf6, #3b82f6, #22d3ee)',
                        backgroundSize: '300% 100%',
                        animation: 'glow-scroll 3s linear infinite',
                      }}
                    >
                      {section.title}
                    </h3>
