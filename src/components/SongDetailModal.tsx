  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fadeIn">
      <div className="relative max-w-2xl w-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-600/20 rounded-3xl blur-3xl"></div>

        {/* Main modal container */}
        <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-cyan-500/30 rounded-3xl shadow-2xl shadow-cyan-500/20 overflow-hidden">
          ...
          <button
            onClick={onClose}
            className="absolute top-6 right-6 z-10 p-2 rounded-full bg-gray-800/80 hover:bg-gray-700 border border-gray-600 hover:border-cyan-500 transition-all duration-200 group"
          >
            <X size={20} className="text-gray-400 group-hover:text-cyan-400 transition-colors" />
          </button>
          ...
          <div className="relative p-8 space-y-6">
            ...
            <div className="flex items-start space-x-6">
              <div className="relative flex-shrink-0">
                <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-cyan-600/30 via-blue-600/30 to-purple-600/30 flex items-center justify-center border border-cyan-500/30 shadow-lg shadow-cyan-500/20">
                  <Music size={64} className="text-cyan-400" />
                </div>
                {/* Pulsing effect */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-cyan-500 to-purple-600 opacity-20 animate-pulse"></div>
              </div>

              <div className="flex-1 min-w-0">
                <h2 className="text-3xl font-bold text-white mb-2 truncate bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
                  {song.originalName}
                </h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-800/30 rounded-xl p-4 border border-cyan-500/20 backdrop-blur-sm">
              ...
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-800/30 rounded-xl p-4 border border-blue-500/20 backdrop-blur-sm">
                <div className="flex items-center space-x-3">
              ...
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-800/30 rounded-xl p-4 border border-purple-500/20 backdrop-blur-sm">
                <div className="flex items-center space-x-3">
            ...
            {(song.analysis?.key || song.analysis?.energy !== undefined) && (
              <div className="flex space-x-4">
                {song.analysis?.key && (
                  <div className="flex-1 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-xl p-3 border border-cyan-500/20">
                    <p className="text-xs text-gray-500 font-medium uppercase tracking-wider mb-1">Musical Key</p>
                    <p className="text-xl font-bold text-cyan-400">{song.analysis.key}</p>
                  </div>
                )}
                {song.analysis?.energy !== undefined && (
                  <div className="flex-1 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl p-3 border border-purple-500/20">
